...
run_test "lib/tadpole.sh exists" "[ -f '$PROJECT_DIR/src/lib/tadpole.sh' ]"
...
# Main entry point
run_test "src/bufo exists" "[ -f '$PROJECT_DIR/src/bufo' ]"
run_test "src/bufo is executable" "[ -x '$PROJECT_DIR/src/bufo' ]"
