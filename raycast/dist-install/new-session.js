...
// src/new-session.tsx
var new_session_exports = {};
__export(new_session_exports, {
  default: () => NewSession
});
module.exports = __toCommonJS(new_session_exports);
      ...
      actions: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_api.ActionPanel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_api.Action.SubmitForm,
        {
          ...
          onSubmit: async (values) => {
            ...
            try {
              await (0, import_api.showToast)({ style: import_api.Toast.Style.Animated, title: "Starting session..." });
              await runBufoAsync(`@${values.project} session start ${values.name.trim()}`);
              await (0, import_api.showToast)({ style: import_api.Toast.Style.Success, title: "Session started" });
